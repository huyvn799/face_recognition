...
class Face_Recognition_System(Toplevel):
    def __init__(self,root):
        ...
        self.title("Hệ thống điểm danh bằng gương mặt UIT")
        ...
        time_img = Label(self, image=self.photoimgtime,bg="white")
        time_img.place(x=43, y=40, width=27, height=27)
        def time():
            string=strftime('%H:%M:%S %p')
            lbl.config(text=string)
            lbl.after(1000,time)
        lbl=Label(self,font=("yu gothic ui", 13, "bold"),bg="white", fg="black")
        lbl.place(x=80,y=35,width=100,height=20)
        time()
        lbl1 = Label(self,text=today, font=("yu gothic ui", 13, "bold"), bg="white", fg="black")
        lbl1.place(x=80, y=60, width=100, height=20)

        #====title=========
        self.txt = "Hệ thống điểm danh bằng gương mặt UIT"
        self.count = 0
        self.text = ''
        self.color = ["#4f4e4d", "#f29844", "red2"]
        self.heading = Label(self, text=self.txt, font=("yu gothic ui", 26, "bold"), bg="white", fg="black",
                             bd=5, relief=FLAT)
        ...
        time_img = Label(self, image=self.photoimgpeop, bg="white")
        time_img.place(x=970, y=45, width=27, height=27)
        self.lblemail = Label(self,text=self.account, font=("yu gothic ui", 12, "bold"), bg="white", fg="green")
        ...
        b1 = Button(self, image=self.photoimglogout, cursor="hand2", command=self.exit,borderwidth=0,bg="white")
        b1.place(x=1350, y=45, width=27, height=27)

        b1_1 = Button(self, text="Đăng xuất", cursor="hand2", command=self.exit,
        ...
        b2 = Button(self, text="Thống kê",font=("yu gothic ui", 16, "bold"),command=self.report_data,image=self.photobtn1,cursor="hand2",
        ...
        btn2 = Button(self, text="Sinh viên", font=("yu gothic ui", 16, "bold"),command=self.student_details, image=self.photobtn2,
                    cursor="hand2",
                    activebackground="white", bg="white", borderwidth=0, compound="top")
        ...
        b3 = Button(self, text="Nhận diện", font=("yu gothic ui", 16, "bold"),command=self.face_recognition ,image=self.photobtn3,
                    cursor="hand2",
                    activebackground="white", bg="white", borderwidth=0, compound="top")
        ...
        b4 = Button(self, text="Điểm danh", font=("yu gothic ui", 16, "bold"),command=self.attendance_data ,image=self.photobtn4,
                    cursor="hand2",
                    activebackground="white", bg="white", borderwidth=0, compound="top")
        ...
        b5 = Button(self, text="Môn học", font=("yu gothic ui", 16, "bold"),command=self.subject_data, image=self.photobtn5,
                    cursor="hand2",
                    activebackground="white", bg="white", borderwidth=0, compound="top")
        ...
        b6 = Button(self, text="Giáo viên", font=("yu gothic ui", 16, "bold"),command=self.teacher_data, image=self.photobtn6,
                    cursor="hand2",
                    activebackground="white", bg="white", borderwidth=0, compound="top")
        ...
        b7 = Button(self, text="Buổi học", font=("yu gothic ui", 16, "bold"),command=self.lesson_data, image=self.photobtn7,
                    cursor="hand2",
                    activebackground="white", bg="white", borderwidth=0, compound="top")
        ...
        b8 = Button(self, text="Xem ảnh", font=("yu gothic ui", 16, "bold"),command=self.open_img, image=self.photobtn8,
                    cursor="hand2",
                    activebackground="white", bg="white", borderwidth=0, compound="top")
        ...
        if(value_from_p1=="0" or value_from_p1==None):
            ...
            change_pass = Button(self, text="Đổi mật khẩu", cursor="hand2", command=self.change_pass,
                          font=("times new roman", 13, "bold"),
                          bg="white", fg="black", borderwidth=0)
