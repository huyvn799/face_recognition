...
class Student:
    def __init__(self,root):
        ...
        dep_combo["values"]=("Chọn chuyên ngành","Công nghệ phần mềm","Khoa học máy tính","Hệ thống thông tin","Kỹ thuât máy tính","Khoa học và kỹ thuật thông tin","MMT và Truyền thông")
        dep_combo.current(0)
        ...
        btn_frame1.place(x=0, y=335, width=715, height=65)
